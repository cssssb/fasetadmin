            ...
            <div class="panel panel-default panel-recharge">
                ...
                <form id="add-form" class="form-horizontal nice-validator n-default n-bootstrap hidden staticxiugai"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <input readonly="1" name="name" class="form-control xiuname" type="text" value="ddgg04">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-4 onlyNumAlpha">连接密码:</label>
                        <div class="col-xs-12 col-sm-4">
                            <input name="password" class="form-control" type="text" value="888"> </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-4">默认线路:</label>
                        <div class="col-xs-12 col-sm-4">
                            <select id="link" class="selectpicker form-control" name="defaultLink" tabindex="-98">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <div class="radio"><label for="row[isp]-1"><input id="row[isp]-1" checked="checked"
                                        name="isp" type="radio" value="1"> 联通</label> <label
                                    for="row[isp]-2"><input id="row[isp]-2" name="isp" type="radio" value="2">
                                    电信</label> <label for="row[isp]-3"><input id="row[isp]-3" name="isp"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-4">
                            <div class="radio"><label for="row[status]-1"><input id="row[status]-1" checked="checked"
                                        name="status" type="radio" value="1"> 启用</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group layer-footer">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <button type="submit" class="btn btn-success btn-embossed xiugaibtn">提交</button>
                            <button type="reset" class="btn btn-default btn-embossed">重置</button>
                        </div>
                    </div>
                </form>
                <h2 class="page-header"><span class="titname">b服务器静态列表</span>---单静态连接账号每天限制1次地区更换 用于变更ip 请及时停止次数不够的账号连接 密码错误的连接 多次尝试可能造成您本地IP进黑名单
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                                        <label for="createtime"
                                                            class="control-label col-xs-4">过期时间</label>
                                                        <div class="col-xs-8"><input type="hidden"
                                        ...
                                        <div class="bs-bars pull-left">
                                            <div id="toolbar" class="toolbar">
                                                ...
                                                <!-- <div class="staticgroup"><a
                                                        ...
                                                        href="javascript:;">切换至e服务器静态列表</a></div> -->
