                    ...
                    <div class="panel-body">
                        ...
                        <form id="add-form" class="form-horizontal nice-validator n-default n-bootstrap" role="form"
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-4">充值类型:</label>
                                <div class="col-xs-12 col-sm-4">
                                        <input id="type" name="row[type]" class="form-control duihuannum" type="text" value="共享点数" disabled="disabled"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group layer-footer">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <button type="button"  class="btn btn-success btn-embossed gongxiang">提交</button>
                                </div>
                            </div>
                        </form>
                    </div>
