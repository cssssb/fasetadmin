...
<script type="text/javascript">
    ...
    温馨提示:卡密为虚拟物品一但充值成功非平台原因不作退款处理!</p>
                      ...
                      <table class="table table-striped table-invite">
                          ...
                          <tr>
                            <th><?php echo $data['has_pwd']; ?></th>
                            <th><?php echo $data['price']; ?></th>
                            <th><?php echo $data['number']; ?></th>
                            <th><?php echo $data['now_number']; ?></th>
                            <th><?php echo $data['c_time']; ?></th>
                        </tr>
                          </thead>
                          <tbody>
                                                    </tbody>
