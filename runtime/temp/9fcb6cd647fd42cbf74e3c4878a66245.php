            ...
            <div class="col-md-9">
                    <div class="panel panel-default panel-recharge">
                            <div class="panel-body">
                                ...
                                <form  class="form-horizontal nice-validator n-default n-bootstrap" role="form"
                                    data-toggle="validator" enctype="multipart/form-data" id="uploads" name="fileinfo">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker" name="serve_id" ></select>
                                    </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                                <select id="link" class="form-control citypick" name="defaultLink"
                                                    tabindex="-98">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-4">
                                            <div class="radio"><label for="row[isp]-1"><input id="row[isp]-1" name="isp"
                                                    ...
                                                    for="row[isp]-3"><input id="row[isp]-3" name="isp" type="radio" value="3">
                                    ...
                                    <div class="form-group layer-footer">
                                        ...
                                        <div class="col-xs-12 col-sm-8">
                                            <button type="button" class="btn btn-success btn-embossed dynamicbtn">提交</button>
