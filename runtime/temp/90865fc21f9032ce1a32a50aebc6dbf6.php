                                            ...
                                            <table id="table"
                                                ...
                                                <tbody data-listidx="0">
                                                    <tr data-index="0">
                                                        ...
                                                        <td style="text-align: center; vertical-align: middle; ">
                                                            <span class="text-success">联通</span></td>
                                                        <td style="text-align: center; vertical-align: middle; ">上海
                                                        </td>
                                                        <td style="text-align: center; vertical-align: middle; ">
                                                            2019-07-09 23:59:59</td>
                                                        <td style="text-align: center; vertical-align: middle; ">
                                                            <span class="text-danger"><i class="fa fa-circle"></i>
                                                                离线</span></td>
                                                        <td style="text-align: center; vertical-align: middle; "
                                                            class="bianji"><a class="btn btn-xs btn-success btn-editone"
                                        ...
                                        <div class="fixed-table-pagination" style="display: block;">
                                            <div class="pull-left pagination-detail"><span class="pagination-info">显示第 1
                                                    到第 10 条记录，总共 20 条记录</span><span class="page-list">每页显示 <span
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li role="menuitem" class="active"><a href="#">10</a>
                                                            </li>
