...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="password" class="control-label col-xs-12 col-sm-2">点数余额:</label>
        <div class="col-xs-12 col-sm-8">
            <!-- <input type="password" class="form-control" id="number" name="row[number]" autocomplete="new-password" value="" data-rule="password" /> -->
            <input type="number" class="form-control" id="number" name="row[number]"  value="" data-rule="number" />
        </div>
    </div>
    <div class="form-group">
