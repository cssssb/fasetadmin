        ...
        <div class="col-md-9">
            <div class="panel panel-default panel-recharge">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="radio"><label for="row[isp]-1"><input id="row[isp]-1" name="row[isp]" type="radio"
                                    value="1"> 联通</label> <label for="row[isp]-2"><input id="row[isp]-2" name="row[isp]"
                                    type="radio" value="2"> 电信</label> <label for="row[isp]-3"><input id="row[isp]-3"
                                    name="row[isp]" type="radio" value="3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="radio"><label for="row[rand]-0"><input id="row[rand]-0" checked="checked"
                                    name="row[rand]" type="radio" value="0"> 无随机</label> <label for="row[rand]-1"><input
                                    id="row[rand]-1" name="row[rand]" type="radio" value="1"> 随机</label></div>
                    </div>
                </div>
                <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-4">到期时间:</label>
                        <div class="col-xs-12 col-sm-4" style="position: relative;">
                            <input data-date-format="YYYY-MM-DD" data-use-current="true" id="times" class="datetimepicker form-control" name="row[expireDate]" type="text" value="2019-10-24">                            </div>
                    </div>
                <div class="form-group" hidden="">
                    <label class="control-label col-xs-12 col-sm-4">过期时间:</label>
                    <div class="col-xs-12 col-sm-4" style="position: relative;">
                        <input data-date-format="YYYY-MM-DD" data-use-current="true" class="datetimepicker form-control"
                            name="row[expireDate]" type="text" value="2025-10-10"> </div>
                </div>
                <div class="form-group" hidden="">
                    <div class="col-xs-12 col-sm-4">
