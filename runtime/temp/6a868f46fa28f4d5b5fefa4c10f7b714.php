                                ...
                                <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                                    ...
                                    <thead>
                                        ...
                                        <tr style="text-align: center; vertical-align: middle;">
                                            ...
                                            <td class="bianji"><a class="btn btn-xs btn-success btn-editone"
