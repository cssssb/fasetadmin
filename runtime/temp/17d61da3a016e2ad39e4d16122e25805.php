                    ...
                    <form id="profile-form" class="form-horizontal" role="form" data-toggle="validator" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-6" style="text-align: right; margin-top:20px;">
                                <button type="button" class="btn btn-success btn-embossed disabled blacksearch"  style="cursor: pointer;">查询</button>
                        ...
                        <div class="form-group normal-footer" >
                            ...
                            <div class="col-xs-12 col-sm-8">
                                <button type="button" class="btn btn-success btn-embossed disabled " style="cursor: pointer;">查询</button>
                                <button type="button" class="btn btn-default btn-embossed" style="cursor: pointer;"><?php echo __('Reset'); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
...
<style>
    ...
    body .demo-class .layui-layer-title{background:#2c3e50; color:#fff; border: none;}
    .layui-layer-content{
