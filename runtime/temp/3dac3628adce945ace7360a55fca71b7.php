...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">对应消耗点数:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-recharge_price" class="form-control" name="row[recharge_price]" type="number" value="<?php echo htmlentities($row['recharge_price']); ?>">
        </div>
    </div>
