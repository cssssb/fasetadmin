    ...
    <?php echo hook('user_sidenav_after'); ?>
        ...
        <div class="col-md-9">
            <div class="panel-body">
                ...
                邀请链接： <span id="link" name="link"><?php echo $user_id; ?>hahahahhahhahha </span><a
