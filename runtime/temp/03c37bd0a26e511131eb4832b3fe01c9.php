    ...
    <?php echo hook('user_sidenav_after'); ?>
        ...
        <div class="col-md-9">
            <div class="panel-body">
                    <?php if(is_array($a['a']) || $a['a'] instanceof \think\Collection || $a['a'] instanceof \think\Paginator): $i = 0; $__LIST__ = $a['a'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?>
                    <li><a target="_blank" href="<?php echo url("","",true,false);?>" title="<?php echo $a['a']; ?>"><?php echo $a['a']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                <h2 class="page-header"><?php echo $a['a']; ?>邀请规则如下 A邀请B，B充值兑换100点A得10点返利 <span><small
