<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:84:"/www/wwwroot/v.zzz80.cn/fasetadmin/public/../application/index/view/user/static.html";i:1577022673;s:77:"/www/wwwroot/v.zzz80.cn/fasetadmin/application/index/view/layout/default.html";i:1577027813;s:74:"/www/wwwroot/v.zzz80.cn/fasetadmin/application/index/view/common/meta.html";i:1577022673;s:77:"/www/wwwroot/v.zzz80.cn/fasetadmin/application/index/view/common/sidenav.html";i:1577022673;s:76:"/www/wwwroot/v.zzz80.cn/fasetadmin/application/index/view/common/script.html";i:1577022673;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <?php echo hook('user_sidenav_after'); ?>
        ...
        <div class="col-md-9">
            <div class="panel panel-default panel-recharge">
                    ...
                    <form id="add-form" class="form-horizontal nice-validator n-default n-bootstrap" role="form"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <select class="form-control  selectpicker" name="serve_id">
                            </select>
                        </div>
                </div> -->
                ...
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-4 onlynum">账号创建数量:</label>
                    <div class="col-xs-12 col-sm-4">
                        <input id="num" name="accountTotal" class="form-control" type="text" value="1">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-4">IP地区:</label>
                    <div class="col-xs-12 col-sm-4">
                        <select id="link" class=" form-control citypick" name="defaultLink" tabindex="-98">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-4">
                        <div class="radio"><label for="row[isp]-1"><input id="row[isp]-1" name="isp" type="radio"
                                    value="1"> 联通</label> <label for="row[isp]-2"><input id="isp" name="row[isp]"
                                    type="radio" value="2"> 电信</label> <label for="row[isp]-3"><input id="row[isp]-3"
                                    name="isp" type="radio" value="3">
                                移动</label> <label for="row[isp]-0"><input id="row[isp]-0" checked="checked"
                                    name="isp" type="radio" value="0"> 不限</label></div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-4">随机分配线路:</label>
                    <div class="col-xs-12 col-sm-4">
                        <div class="radio"><label for="row[rand]-0"><input id="row[rand]-0" checked="checked"
                                    name="rand" type="radio" value="0"> 无随机</label> <label for="row[rand]-1"><input
                                    id="row[rand]-1" name="rand" type="radio" value="1"> 随机</label></div>
                    </div>
                </div>
                <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-4">到期时间:</label>
                        <div class="col-xs-12 col-sm-4" style="position: relative;">
                            <input data-date-format="YYYY-MM-DD" data-use-current="true" id="times" class="datetimepicker form-control" name="expireDate" type="date" value="2019-10-24">                            </div>
                    </div>
                <div class="form-group">
                    <label class="control-label col-xs-12 col-sm-4">点数:</label>
                    <label class="control-label col-xs-12 col-sm-4" style="text-align:left"><span style="color:red"
                            id="code"></span></label>
                </div>
                <div class="form-group">
                ...
                <div class="form-group layer-footer">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <button type="button" class="btn btn-success btn-embossed staticbtn">提交</button>
